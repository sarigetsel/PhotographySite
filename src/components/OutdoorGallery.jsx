...
import { getAllOutdoorPicPaths } from '../utils/images'
...
export default function OutdoorGallery({ showHeader = true }) {
  const images = getAllOutdoorPicPaths()
        ...
        {showHeader && (
          ...
          >
            ...
            <p className="mx-auto mt-4 max-w-lg text-brand-dark/65">
              רגעים של טבע וחופש — לחצו על תמונה להגדלה
            </p>
          </motion.div>
        )}
