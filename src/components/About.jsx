        ...
        <div className="mb-20 grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          >
            ...
            <p className="leading-relaxed">
              הגעתי לעולם הצילום מתוך אהבה עמוקה לרגעים הקטנים — המבט, החיוך
            ...
            <p className="leading-relaxed">
              ...
              יפה והאווירה הכי טבעית. בין אם מדובר ביום הולדת, משפחה גדולה
              או סתם יום יפה בטבע — אני שם כדי לתת לכם זיכרון שישאר
              לנצח.
            </p>
